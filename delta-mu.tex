...
%The experimental cycle involves a Ramsey
...
%In
%order for this correction technique succeed, gradient fields must be
%controlled or corrected for at the $<1$~nT/m level.  Furthermore the
%stability of the $B_0$ field must be controlled as well as possible,
%normally at the 1-10~pT level over the UCN free-precession time.
...
%, normally directed vertically in the apparatus.  
...
\bibitem{bib:cpviolationwithoutstrangeness} I. B. Khriplovich,
...
\bibitem{bib:bartman} Bartington Instruments, Operation Manual 1004, Issue 23
\end{thebibliography}
