...
The initial design of the $\mu(T)$ measurement included tygon tubing wrapped around the witness cylinder in an spiral pattern to flow water and change the temperature of the witness cylinder. In those measurements, the amplitude of the signal was measured  from an oscilloscope and no lock-in amplifier was used. The mechanical stability issues dominated the systematic uncertainties. When water was running, the flexibility of the tubing caused the witness cylinder to move. As an alternative, the tubes were replaced by copper tubes. In this case, it was impossible to create enough contact between the tubes and the witness cylinder. In another design, a TEC was replaced with the tubing. The main issue with this design was that it did not provide enough and it was creating only local temperature changes on the witness cylinder. In addition, despite of using heat sinks, the heat created by the TEC itself made it very inefficient.
The final design included the witness cylinder, which was placed with a holder inside the innermost prototype passive shield. The temperature variations of the witness cylinder was caused by the temperature changes in the room which was due to the on and off cycles of the building air conditioner. The bartington fluxgate was holed inside the witness cylinder at the centre by plastic holder.
% Another list
% - amplitude measurement on oscilloscope (no lock-in).
% - speed of temperature change? temperature homogeneity?  (not here yet)
% - other methods of cooling and why they didn't work. (not here yet)
% - magnetic contamination by thermocouples
...
% - field profile/homogeneity
% - mechanical stability
% - thermal expansion
% - temperature dependence of fluxgate and SCU (don't appear here yet)
% - temperature dependence of lock-in
% - temperature dependence of coil resistance (not here yet)
% - null measurement (Cu, and why it doesn't give the whole story, not here yet)
...
There were multiple sources of systematic error contributing to this
measurement. All the components interior to the measurement volume
should be non-magnetic and it includes the thermocouples. In this
case, T type thermocouples were used.
...
study the dependence of the field profile to $\mu(T)$.
...
% reaction factor with temperature.

The movement of the fluxgate flying lead due to the thermal expansion
was also taken into account. For 1~mm change of angle the magnetic
field changed by 0.00003/$^\circ$C.
% explain better what was calculated

The thermal expansion of the mu-metal cylinder was calculated and was
negligible.
% how negligible?  There should be a number, then we decide if
% negligible is reasonable.

For these measurement an SRS830 lock-in amplifier has been used which
has 50 ppm/$^\circ$C amplitude stability.
% This was tested.  Explain how.  What was the result?
