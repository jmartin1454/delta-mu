...
To eliminate the coupling of field profile and mechanical stabilities another coil was used which was coupled to the witness cylinder as shown in Fig. \ref{fig:geometry}. This also enabled us to study the dependence of the field profile to $\mu(T)$.
The movement of the fluxgate flying lead due to the thermal expansion was also taken into account. For 1~mm change of angle the magnetic field changed by 0.00003/$^\circ$C which is very small. The thermal expansion of the mu-metal cylinder was calculated and was negligible.
In this model it was found that 0.6\%/K $\lesssim\frac{1}{\mu}\frac{d\mu}{dT}\lesssim 2.3\%$/K. Although for most the measurements the general trend of $B(T)$ graphs was consistent, the shape and positions of the minor loops were changing due to unidentified sources of systematic errors and these are all included in the reported error bar of this measurement. A reasonable hypothesis might be different properties of each witness cylinder related to different annealing processes.
%\begin{itemize}
...
\end{figure} 
\subsubsection{systematic errors}
The dominant source of systematic uncertainty in this experiment arises from the properties of witness cylinders. Despite of the consistent general trend of $B(T)$, different witness cylinders tend to behave differently under similar conditions. Saturation and magnetization of the witness cylinders and in general the nonlinearity of $/mu$ had a considerable impact on the measured signal.
