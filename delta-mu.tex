...
Mechanical and temperature changes of the experiment setup and the
...
permeable materials such as Mu-Metal which is a Ni-Fe alloy that
allows measurements at low frequency magnetic fields. Ni-Fe alloys
...
such as the magnetic permeability, $\mu$ \cite{bib:couderchon}. For
these type of alloys $\mu$ depends also on the annealing process
\cite{bib:gupta}. The temperature dependence of $\mu$ has been
...
% 
% more literature?
% What about the Krupp-VDM datasheet?
%
...
shield into a return yoke and its due to the penetration of the
...
a function of relative $\mu_r=\mu/\mu_0$ for coil radius 0.53~m and
$a=0.57$~m and a thickness of 1.5~mm for the shield which are
comparable to the dimensions of the ILL nEDM experiment
setup~\cite{bib:baker,bib:knecht}.
\begin{figure}[h!]
\begin{center}
   \includegraphics[width=0.6\textwidth]{femm_and_calcs.pdf}
    \caption{Magnetic field as a function of relative magnetic
      ...
      radius 0.57~m, thickness 1.5~mm.  XXX and XXX points are
...
FEMM~\cite{bib:femm}.  In the first, the same spherical geometry was
...
generate the correct image currents in the infinite $\mu$ limit.  As
shown in Fig.~\ref{fig:Magnetic_Field}, the slope of $B(\mu)$ is
...
In the spherical case the reaction factor is XXX.  In the cylindrical
case the reaction factor is XXX.  In general, it is expected that the
...
A way decouple the internal coil from the magnetic shield is to design
a self-shielded
...
to the coil is coupled to the properties of the shell which is caused
by the penetration of the magnetic field into the shell material. In a
...
Couderchon et al. measured the thermal variation of $\mu$ of two
different Ni-Fe alloys in a low field and they found
...
% Taraneh
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% refer to Pfeifer paper (I put it in the last entry in the
% bibliography).  See if you can find more papers?
...
\bibitem{bib:pfiefer} F. PFEIFER and C. RADELOFF, Journal of Magnetism
  and Magnetic Materials 19 (1980) 190-207
