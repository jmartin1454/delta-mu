...
Neutron EDM experiments are DC measurements with frequencies smaller than 0.01 Hz. The applied static magnetic field   is typically 1~$\mu$T. This produces a $B$ field of 170~$\mu$T and an $H$ field of 0.007~A/m internal to the shield material for dimensions described in Sec. \ref{sec:femm}.
