...
is $>$ 1 for spherical and cylindrical geometries~\cite{bib:bidinosti}. The coupling of the coil to the
...
alloys in a low field and they found $\frac{1}{\mu}\frac{d
  \mu}{dT}\simeq$1\%/K at room
...
fluxgate magnetometer measured the magnetic field at the center of the
...
The signal from the fluxgate was demodulated by a lock-in
