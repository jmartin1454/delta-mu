...
\begin{center}
   \includegraphics[width=0.6\textwidth]{femm_and_calcs.pdf}
    \caption{This graph shows magnetic field in $\mu$T as a function
      of relative magnetic permeability $\mu$ for an ideal spherical
      surface current of radius $0.53$ m inside a spherical shell of
      inner radius 0.57 m and a thickness of 1.5 mm. (fix the
      caption)}
