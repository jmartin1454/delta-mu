...
The windings were not potted in place.  Three witness cylinders were
tested.  Data were acquired using different numbers of turns on both
the primary and secondary coils (from 6 to 48 on the primary, and from
7 to 24 on the secondary).
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[height=3cm]{picture.pdf}\hskip1cm
    \includegraphics[height=3cm]{figure4-crop.pdf}
    \caption{Phototgraph of a witness cylinder showing transformer
      windings (left); schematic of the transformer measurement
      (right) with position of the transformer indicated as ``C''.
      The primary coil was driven by the sine-out of an SR830 lock-in
      amplifier, which was also used to demodulate induced voltage
      $V(t)$ in the secondary coil.  The driving current $I(t)$ was
      measured by measuring the voltage across a stable 1~$\Omega$
      resistor.}
